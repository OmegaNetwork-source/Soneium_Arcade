...
import {
	MAX_STYLESTRING, MAX_CL_STATS, MAX_SCOREBOARD, MAX_SCOREBOARDNAME,
	MAX_MODELS, MAX_SOUNDS, MAX_EDICTS, MAX_LIGHTSTYLES, entity_state_t
} from './quakedef.js';
...
export class client_state_t {
	...
	constructor() {
		...
		// Wallet score tracking
		this.wallet_score = 0;
		this.wallet_score_submitted = false;
		this.death_score_submitted = false;

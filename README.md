...
- **Soulbound ERC-721** on Soneium: mint on the hub, **one per wallet**, **unlimited** total supply, **non-transferable** (no secondary sales). Mint cost is set in the contract and shown in your wallet at confirm time.

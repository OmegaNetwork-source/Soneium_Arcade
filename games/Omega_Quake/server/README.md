# Omega Quake Dedicated Server

A dedicated server for Omega Quake that runs headlessly using Deno and WebTransport.
...
In the Omega Quake browser client, use the `connect` command:

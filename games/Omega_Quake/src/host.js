...
import {
	Con_Printf, Con_DPrintf, Con_SetPrintFunctions, SZ_Write, SZ_Clear,
	MSG_WriteByte, MSG_WriteShort, MSG_WriteLong, MSG_WriteFloat,
	MSG_WriteString, MSG_WriteAngle, COM_Parse, com_token
} from './common.js';
import {
	svc_signonnum, svc_time, svc_updatename, svc_updatefrags,
	svc_updatecolors, svc_lightstyle, svc_updatestat, svc_setangle,
	svc_clientdata, svc_print, svc_setpause
} from './protocol.js';
import {
	STAT_TOTALSECRETS, STAT_TOTALMONSTERS, STAT_SECRETS, STAT_MONSTERS,
	MAX_LIGHTSTYLES, SAVEGAME_COMMENT_LENGTH
} from './quakedef.js';
...
import {
	SV_Physics, SV_SetFrametime, FL_GODMODE, FL_NOTARGET,
	MOVETYPE_WALK, MOVETYPE_FLY, MOVETYPE_NOCLIP
} from './sv_phys.js';
import {
	sv, svs, client_t, NUM_SPAWN_PARMS, NUM_PING_TIMES,
...
export const registered = new cvar_t('registered', '1');
...
export async function Host_Init(parms) {
	...
	Con_Printf('Omega Quake Version 1.09\n');
	Con_Printf('Exe: omega-quake (JavaScript/Three.js)\n');

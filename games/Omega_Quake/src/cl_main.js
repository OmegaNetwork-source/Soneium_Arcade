...
import {
	Con_Printf, Con_DPrintf, SZ_Alloc, SZ_Clear,
...
import {
	SIGNONS, MAX_DLIGHTS, MAX_EFRAGS, MAX_BEAMS, MAX_TEMP_ENTITIES,
...
import {
	CL_InitPrediction, CL_ResetPrediction, CL_PredictMove,
	CL_GetPredictedPlayer, CL_SetUpPlayerPrediction,
	CL_GetServerSequence, CL_GetValidSequence, CL_GetEntityFrame,
	cl_simorg, cl_simvel, cl_simangles, cl_nopred, set_cl_simonground
} from './cl_pred.js';
...
export function CL_ClearState() {
	...
	// Reset wallet score tracking
	cl.wallet_score = 0;
	cl.wallet_score_submitted = false;
	cl.onground = false;
	cl.inwater = false;
	cl.intermission = 0;
	cl.completed_time = 0;
